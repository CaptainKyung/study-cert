    ...
    <div style={{ minHeight:'100vh', background:colors.bg, display:'flex',
      ...
      <div style={{ width:'100%', maxWidth:380, padding:'0 24px' }}>
        ...
        <div style={{ textAlign:'center', marginBottom:40 }}>
          ...
          <h1 style={{ color:'#fff', fontSize:26, fontWeight:900, margin:0 }}>스터디 인증</h1>
          <p style={{ color:'#666', fontSize:14, marginTop:8 }}>매일 공부 인증하고 함께 성장해요</p>
        </div>

        <div style={{ background:colors.card, borderRadius:20, padding:28,
          border:`1.5px solid ${colors.border}` }}>

          {/* 탭 */}
          <div style={{ display:'flex', background:colors.bg, borderRadius:12,
          ...
          {mode === 'register' && (
            <>
              <p style={{ color:colors.textSecondary, fontSize:13, marginBottom:8 }}>아바타 선택</p>
